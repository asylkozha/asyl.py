...
image_coin = pygame.image.load('resources/coin.png')  # Монетка
...
class Coin(pygame.sprite.Sprite):
    ...
    def generate_random_pos(self):
        w = min(self.rect.width, WIDTH - 1)
        h = min(self.rect.height, HEIGHT // 2 - 1)
        self.rect.left = random.randint(0, WIDTH - w)
        self.rect.top = random.randint(0, HEIGHT // 2 - h)
...
while running:
    ...
    # Увеличение скорости врага каждые 5 очков
